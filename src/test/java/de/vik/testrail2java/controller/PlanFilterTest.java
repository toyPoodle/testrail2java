...
public class PlanFilterTest {
    ...
    public void filterKeys() throws Exception {
        ...
        assertThat(PlanFilter.byCreatedBy(userId(1), userId(2)), asStringIs("created_by=1,2"));
        ...
        assertThat(PlanFilter.byMilestoneId(milestoneId(8), milestoneId(9)), asStringIs("milestone_id=8,9"));
    }
}